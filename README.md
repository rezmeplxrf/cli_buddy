...
## Call Any LLM from Your Terminal
  ...
  **(Due to some dependencies using 'package:win32/win32.dart' through FFI, Pub.dev analysis will falsely label it as 'Windows' only but it works on Linux, macOS, and Windows without any issues)**
