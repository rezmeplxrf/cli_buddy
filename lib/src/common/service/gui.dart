...
class GUIService {
  ...
  Future<void> start() async {
    final handler =
        const Pipeline().addMiddleware(logRequests()).addHandler(_htmlHandler);
    ...
    <div class="main-content">
      <div class="chat-container">
        ...
        <div class="message user-message">
          <p>Hi! Can you explain what HTML is?</p>
        </div>
        <div class="message ai-message">
          <p>
            HTML stands for HyperText Markup Language. It's the standard markup
            language used to create web pages. HTML describes the structure of a
            web page semantically and originally included cues for the
            appearance of the document.
          </p>
          <p>
            HTML elements are the building blocks of HTML pages. With HTML
            constructs, images and other objects, such as interactive forms, can
