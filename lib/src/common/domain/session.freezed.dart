...
class _$UserMessageImpl implements _UserMessage {
  const _$UserMessageImpl({this.role, this.content, this.timestamp});
  ...
  @override
  String toString() {
    return 'UserMessage(role: $role, content: $content, timestamp: $timestamp)';
  }
...
abstract class _UserMessage implements UserMessage {
  const factory _UserMessage(
      {final String? role,
      final String? content,
      final int? timestamp}) = _$UserMessageImpl;
