...
/// ```
/// {@endtemplate}
class CliBuddyCommandRunner extends CompletionCommandRunner<int> {
  /// {@macro cli_buddy_command_runner}
  CliBuddyCommandRunner({
    Logger? logger,
    ...
    addCommand(ShellCommand(logger: _logger));
